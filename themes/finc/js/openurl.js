/**
 ...
 usage: {}
 modified for finc:
 * has its own specific 'resolvertype', make sure it is included when updating
 * to chose the right resolver, we have to get the resolvertype #5334
 configured in: {}
 */
...
VuFind.register('openurl', function OpenUrl() {
  ...
  function embedOpenUrlLinks(el) {
    ...
    // finc: to chose the right resolver, we have to get the resolvertype #5334
