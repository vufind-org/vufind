/**
 ...
 usage: {}
 modified for finc:
 * Prevent freezing of the "loading..." information, instead show the record details - #18898
 * add aria-label #17915
 configured in: {}
 */
  ...
  function setupChannelSlider(i, op) {
    ...
    $(op).find('.channel-record').unbind('click').click(function channelRecord(event) {
      ...
      if (!record.data("popover-loaded")) {
        ...
        $.ajax({
          // finc: Prevent freezing of the "loading..." information, instead show the record details - #18898 - HR
          // finc: adds '/' + urlroot + '/'  +
