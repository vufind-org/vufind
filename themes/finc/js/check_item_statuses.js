/**
 ...
 usage: {}
 modified for finc:
 * hide location and callnumber information if both are empty #5737
 configured in: {}
 */
...
VuFind.register('itemStatuses', function ItemStatuses() {
  ...
  function displayItemStatus(result, $item) {
    ...
    if (typeof(result.error) != 'undefined'
     ...
     // finc: next three lines finc-specific, added in #5737, check functionality, CK - Fixme 5.1
    } else if (result.callnumber.length == 0 && result.location.length == 0) {
      // finc: hides location and callnumber information if both are empty
