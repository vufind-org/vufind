/**
 ...
 usage: {}
 modified for finc:
 * keep _origin - see #17984
 * keep role='alert' - see #18988 and #18790
 * accessibility: set id for aria-label #19695
 * avoid page reload after login if param is given - show account links by javascript #18988
 * Login without Page Reload #18988
 * Copied finc #17984
 configured in: {}
 */
...
VuFind.register('lightbox', function Lightbox() {
  ...
  function showAlert(message, _type) {
    var type = _type || 'info';
    // finc: keeps role='alert' - see #18988 and #18790
  ...
  function render(content) {
    ...
    // finc: accessibility: set id for aria-label #19695
      ...
      .done(function lbAjaxDone(content, status, jq_xhr) {
        ...
        if (
          ...
          if (_originalUrl.match(/UserLogin/) || obj.url.match(/catalogLogin/)) {
            ...
            return false;
          /* finc: avoids page reload after login if param is given - shows account links by javascript #18988 */
  ...
  /** finc: Login without Page Reload #18988 */
  ...
  // finc: restores focus after deleting records, #20379
  ...
  function init() {
    ...
    _modal.on('hidden.bs.modal', function lightboxHidden() {
      ...
      // finc: sets focus back on launching element #18988, #17984
