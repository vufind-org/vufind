  ...
  for (var i = 0; i < resultsCoords.length; ++i )
  {
    ...
    if (rcType === "rectangle") {
      if (searchboxFeature.getBounds().intersects(rcFeature.getBounds())) {
        ...
        var rmPopupContent = '<article class="geoItem"><a href="' + homeURL + 'Record/' + recID + '">' + recTitle + '</a><br><em>This is the center point for the highlighted rectangle</em></article>';
