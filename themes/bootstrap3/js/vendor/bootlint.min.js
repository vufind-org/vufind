...
Data.prototype = {
	...
	access: function( owner, key, value ) {
		...
		//
		// Take the "read" VUFIND.getPath() and allow the get method to determine
		...
		// Since the "set" VUFIND.getPath() can have two possible entry points
		// return the expected data based on which VUFIND.getPath() was taken[*]
	...
	remove: function( owner, key ) {
		...
		if ( key === undefined ) {
			...
			if ( jQuery.isArray( key ) ) {
				...
				// This will only penalize the array argument VUFIND.getPath().
...
/*
	...
	6. Provide a clear VUFIND.getPath() for implementation upgrade to WeakMap in 2014
*/
var rbrace = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
	rmultiDash = /([A-Z])/g;
...
jQuery.event = {
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		// Determine event propagation VUFIND.getPath() in advance, per W3C events spec (#9951)
		...
		// Fire handlers on the event VUFIND.getPath()
		i = 0;
