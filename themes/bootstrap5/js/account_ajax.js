...
$(function registerAccountAjax() {
  ...
  VuFind.account.register("checkedOut", {
    ...
    render: function render($element, status, ICON_LEVELS) {
      ...
      if (status.ok > 0) {
        html += '<span aria-hidden="true" class="badge account-info" data-toggle="tooltip" title="' + VuFind.translate('account_normal_checkouts') + '">' + status.ok + '</span>' +
        '<span class="visually-hidden">' + VuFind.translate('account_normal_checkouts') + ': ' + status.ok + ' , ' + '</span>';
      }
      if (status.warn > 0) {
      ...
      if (status.overdue > 0) {
        html += '<span aria-hidden="true" class="badge account-alert" data-toggle="tooltip" title="' + VuFind.translate('account_checkouts_overdue') + '">' + status.overdue + '</span>' +
        '<span class="visually-hidden">' + VuFind.translate('account_checkouts_overdue') + ': ' + status.overdue + ' , ' + '</span>';
  ...
  VuFind.account.register("holds", {
    ...
    render: function render($element, status, ICON_LEVELS) {
      ...
      if (status.available > 0) {
        html += '<span aria-hidden="true" class="badge account-info" data-toggle="tooltip" title="' + VuFind.translate('account_requests_available') + '">' + status.available + '</span>' +
        '<span class="visually-hidden">' + VuFind.translate('account_requests_available') + ': ' + status.available + ' , ' + '</span>';
      ...
      if (status.in_transit > 0) {
        ...
        '<span class="visually-hidden">' + VuFind.translate('account_requests_in_transit') + ': ' + status.in_transit + ' , ' + '</span>';
      }
      if (status.other > 0) {
        ...
        '<span class="visually-hidden">' + VuFind.translate('account_requests_other') + ': ' + status.other + ' , ' + '</span>';
      }
      if (html !== '') {
        $element.html(html);
      } else {
