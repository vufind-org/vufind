...
var Lightbox = {
  ...
  confirm: function(message) {
    this.changeContent('<div data-alert class="alert-box info" tabindex="0" aria-live="assertive" role="dialogalert">'+message+'</div><button href="#" role="button" tabindex="0" class="close tiny" aria-label="Close Alert" onClick="Lightbox.close()">'+vufindString['close']+'</button>');
  },
  /**
