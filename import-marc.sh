...
RUN_CMD="$JAVA $INDEX_OPTIONS -Duser.timezone=UTC -Duser.VUFIND_HOME=$VUFIND_HOME $EXTRA_SOLRMARC_SETTINGS -jar $JAR_FILE $PROPERTIES_FILE -solrj $VUFIND_HOME/solr/vendor/dist/solrj-lib $MARC_PATH/$MARC_FILE"
