...
build_browse "dewey" "dewey-raw" 1 "-Dbibleech=StoredFieldLeech -Dsortfield=dewey-sort-browse -Dvaluefield=dewey-raw -Dbrowse.normalizer=org.vufind.util.DeweyCallNormalizer"
