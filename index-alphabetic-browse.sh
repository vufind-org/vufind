...
cd "`dirname $0`/import"
CLASSPATH="browse-indexing.jar:/opt/solr/server/solr/jars/*:/opt/solr/server/solr/*:/opt/solr/server/solr/analysis-extras/lib/*:/usr/local/vufind/solr/vendor/server/solr-webapp/webapp/WEB-INF/lib/*"
