...
class VisualMaterialTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    function testGetBib(){
        $bib = Bib::find(233539402, $this->mockAccessToken);
    ...
    {
        $this->assertContains('library:VisualMaterial', $bib->types());
