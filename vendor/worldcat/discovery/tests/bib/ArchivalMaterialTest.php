...
class ArchivalMaterialTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     *@vcr bibArchivalMaterial
     */
    function testGetBib(){
        $bib = Bib::find(754931850, $this->mockAccessToken);
    ...
    function testParseTypes($bib)
    {
        ...
        $this->assertContains('library:ArchiveMaterial', $bib->types());
    }
