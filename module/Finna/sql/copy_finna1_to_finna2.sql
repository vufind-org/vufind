...
-- Convert advanced searches that don't have groups to basic searches
UPDATE search SET search_object=CONCAT(
    SUBSTRING(search_object, 1, INSTR(search_object, 's:2:"ty";s:8:"advanced";')-1), 
    's:2:"ty";s:5:"basic";', 
    SUBSTRING(search_object, INSTR(search_object, 's:2:"ty";s:8:"advanced";')+24)
  )
  WHERE search_object like '%advanced%' and search_object not like '%s:1:"g"%';

-- Fix join
UPDATE search SET search_object=CONCAT(
    SUBSTRING(search_object, 1, INSTR(search_object, 's:1:"b";N;')-1), 
    's:1:"b";s:3:"AND";', 
    SUBSTRING(search_object, INSTR(search_object, 's:1:"b";N;')+10)
  )
  WHERE search_object like '%advanced%' and search_object like '%s:1:"b";N;%';

-- Fix bool
UPDATE search SET search_object=CONCAT(
    SUBSTRING(search_object, 1, INSTR(search_object, 's:1:"j";N;')-1), 
    's:1:"j";s:3:"AND";', 
    SUBSTRING(search_object, INSTR(search_object, 's:1:"j";N;')+10)
  )
  WHERE search_object like '%advanced%' and search_object like '%s:1:"j";N;%';
UPDATE search SET search_object=CONCAT(
    SUBSTRING(search_object, 1, INSTR(search_object, 's:1:"j";s:0:"";')-1), 
    's:1:"j";s:3:"AND";', 
    SUBSTRING(search_object, INSTR(search_object, 's:1:"j";s:0:"";')+15)
  )
  WHERE search_object like '%advanced%' and search_object like '%s:1:"j";s:0:"";%';
