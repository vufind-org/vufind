...
define("_BIB_REF_CMD_PARAMS_", implode(' ', [_BIB_REF_MAPS_PATH_ . 'bible_aliases.map', 'books_of_the_bible_to_code.map',
       _BIB_REF_MAPS_PATH_ . 'books_of_the_bible_to_canonical_form.map', _BIB_REF_MAPS_PATH_ . 'pericopes_to_codes.map']));
