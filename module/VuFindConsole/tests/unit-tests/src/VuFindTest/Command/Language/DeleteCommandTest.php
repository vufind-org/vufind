...
class DeleteCommandTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @param ExtendedIniType     $reader      Reader for .ini files
    ...
    protected function getMockCommand(ExtendedIniNormalizer $normalizer = null,
        ExtendedIniType $reader = null, $languageDir = null,
     ...
     * @param array $methods Methods to mock
     *
     * @return ExtendedIniType
     */
    protected function getMockReader($methods = [])
    {
        return $this->getMockBuilder(ExtendedIniType::class)
            ->disableOriginalConstructor()
            ->setMethods($methods)
            ->getMock();
    }
