...
class TagsController extends AbstractAdmin
{
    ...
    public function homeAction()
    {
        ...
        $view->statistics = $this->getTable('resourcetags')->getStatistics();
        return $view;
    }
    ...
    public function deleteAction()
    {
        ...
        $origin = !is_null($this->params()->fromPost('origin', null))
            ? $this->params()->fromPost('origin')
            : $this->params()->fromQuery('origin', null);
     ...
     *
     */
    public function deleteResourceTagsByFilter()
    {
        ...
        $this->getTable('ResourceTags')->deleteByIdArray($ids);
        return(count($ids));
    }
