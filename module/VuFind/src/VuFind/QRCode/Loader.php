...
class Loader implements \Zend\Log\LoggerAwareInterface
{
    ...
    public function __construct($config, \VuFindTheme\ThemeInfo $theme,
        ...
        $this->client = $client;
        // This is not currently used but may be of use for future developments
        $this->baseDir = rtrim(
     ...
     *
     * @param string $text The QRCode Text
     *
     * @return void
     */
    public function loadQRCode(
        $text, $params = array('level' => "L", 'size' => "3", 'margin' => "4"))
    {
        // Sanitize parameters:
        $this->text = $text;
        $this->params = $params;
