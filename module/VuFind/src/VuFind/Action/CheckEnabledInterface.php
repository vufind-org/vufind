...
/**
 * "Check Enabled" Interface -- provides getters and setters for toggling the check for the action being enabled.
 *
 * PHP version 8
 *
 ...
 * @link     https://vufind.org Main Page
 */
interface CheckEnabledInterface extends ActionConfigInterface
{
    /**
