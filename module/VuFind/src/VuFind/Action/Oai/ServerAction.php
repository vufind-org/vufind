 ...
 * @link     https://vufind.org Main Site
 */
class ServerAction extends AbstractOaiServerAction
{
    /**
     * Constructor.
     *
     ...
     * @param Server          $server                 Biblio server
     */
    ...
    /**
     * Handle an OAI-PMH request on the biblio index.
     *
