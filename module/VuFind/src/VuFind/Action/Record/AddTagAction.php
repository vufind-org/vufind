 ...
 * @link     https://vufind.org Main Site
 */
class AddTagAction extends AbstractRecordAction
{
    /**
     * Constructor.
     *
    ...
    public function action(
        ...
        // Save tags, if any:
        if ($tags = $this->getPostParam('tag')) {
            $this->tagsService->linkTagsToRecord($driver, $user, $tags);
            $this->getHelper(FlashMessagesHelper::class)->addSuccessMessage(['msg' => 'add_tag_success']);
            return $this->redirectToRecord();
        }

        // Display the "add tag" form:
        return $this->renderTemplate($request, $response, $this->getTemplateParams(), 'record/addtag');
    }
}
