...
class SolrMarc extends SolrDefault
{
     ...
     * @return array
     */
    public function getPublicationInfo($subfield = 'a')
    {
        // First check old-style 260a place:
        $results = $this->getFieldArray('260');
