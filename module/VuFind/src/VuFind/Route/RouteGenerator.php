...
class RouteGenerator
{
    ...
    /**
     * Add a library card route to the configuration.
     *
     * @param array  $config    Configuration array to update
     * @param string $routeName Name of route to generate
     * @param string $action    LibraryCards action
     *
     * @return void
     */
    public function addLibraryCardRoute(& $config, $routeName, $action)
    {
    ...
    /**
     * Add library card routes to the configuration.
     *
     * @param array $config Configuration array to update
     ...
     * @return void
     */
    public function addLibraryCardRoutes(& $config, $routes)
    {
        // Build library card routes
        foreach ($routes as $routeName => $action) {
            $this->addLibraryCardRoute($config, $routeName, $action);
        }
    }
