 ...
 * @link     https://vufind.org Main Page
 */
class IllRequestsHelper extends AbstractRequestBase
{
    /**
    ...
    public function cancelILLRequests(
        ...
        if (!empty($details)) {
            ...
            if ($cancelResults == false) {
                ...
                if ($failed) {
                    $this->flashMessenger->addErrorMessage(
                        [
                            'msg' => 'ill_request_cancel_fail_items',
                            'tokens' => ['%%count%%' => $failed],
                        ]
                    );
                }
            ...
            $this->flashMessenger->addErrorMessage('ill_request_empty_selection');
        }
        return [];
    }
}
