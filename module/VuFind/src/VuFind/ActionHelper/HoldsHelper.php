    ...
    public function addCancelDetails(
        ...
        if ($cancelStatus) {
            if ($cancelStatus['function'] == 'getCancelHoldLink') {
                // Build OPAC URL
                $ilsDetails['cancel_link'] = $catalog->getCancelHoldLink($ilsDetails, $patron);
                ...
                $cancelDetails = $catalog->getCancelHoldDetails($ilsDetails, $patron);
                if ($cancelDetails !== '') {
