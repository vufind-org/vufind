...
trait TranslatorAwareTrait
{
     ...
     * @return string
     */
    protected function translateString($domain, $str, $tokens = [], $default = null)
    {
     ...
     *
     * @param string|array $str String to parse or an array of text domain and string
     * to translate
     *
     * @return array
     */
