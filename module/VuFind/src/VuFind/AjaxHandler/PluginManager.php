...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'notificationsclose' => NotificationsClose::class,
        'NotificationsClose' => NotificationsClose::class,
        'notificationsreorder' => NotificationsReorder::class,
        'NotificationsReorder' => NotificationsReorder::class,
        'notificationsvisibility' => NotificationsVisibility::class,
        'NotificationsVisibility' => NotificationsVisibility::class,
    ...
    protected $factories = [
        ...
        NotificationsClose::class => NotificationsCloseFactory::class,
        NotificationsReorder::class => NotificationsReorderFactory::class,
        NotificationsVisibility::class => NotificationsVisibilityFactory::class,
