...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        NotificationsBroadcastsServiceInterface::class => NotificationsBroadcastsService::class,
        NotificationsPagesServiceInterface::class => NotificationsPagesService::class,
    ...
    protected $factories = [
        ...
        NotificationsBroadcastsService::class => NotificationsBroadcastsServiceFactory::class,
        NotificationsPagesService::class => NotificationsPagesServiceFactory::class,
