...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'notifications_broadcasts' => NotificationsBroadcasts::class,
        'notifications_pages' => NotificationsPages::class,
    ...
    protected $factories = [
        ...
        NotificationsBroadcasts::class => NotificationsBroadcastsFactory::class,
        NotificationsPages::class => NotificationsPagesFactory::class,
