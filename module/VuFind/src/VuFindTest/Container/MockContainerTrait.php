...
trait MockContainerTrait
{
    ...
    /**
     * Returns true if the service has not been populated yet but will be autogenerated
     * on demand.
     *
     * @param string $rawId Identifier of the entry to look for.
     *
     * @return bool
     */
    public function willAutoMockService($rawId): bool
    {
        $id = $this->mockAliases[$rawId] ?? $rawId;
        return $this->has($id) && !isset($this->mockServices[$id]);
    }
