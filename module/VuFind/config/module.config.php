...
$config = [
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            \VuFind\OAuth2\Repository\AccessTokenRepository::class => \VuFind\ServiceManager\Factory\AutowiringFactory::class,
            \VuFind\OAuth2\Repository\AuthCodeRepository::class => \VuFind\ServiceManager\Factory\AutowiringFactory::class,
            \VuFind\OAuth2\Repository\ClientRepository::class => \VuFind\ServiceManager\Factory\AutowiringFactory::class,
            \VuFind\OAuth2\Repository\RefreshTokenRepository::class => \VuFind\ServiceManager\Factory\AutowiringFactory::class,
            \VuFind\OAuth2\Repository\ScopeRepository::class => \VuFind\ServiceManager\Factory\AutowiringFactory::class,
