...
class PluginManagerTest extends \VuFindTest\Unit\TestCase
{
    ...
    {
        $this->setExpectedException(\Zend\ServiceManager\Exception\InvalidServiceException::class, 'Plugin ArrayObject does not belong to VuFind\\Session\\HandlerInterface');
