...
class FolioTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetBoundWithRecords(): void
    {
        ...
        $expected = [
            [
                'title' => 'Slavery as it once prevailed in Massachusetts : A lecture for the Massachusetts Historical Society ...',
                'bibId' => '12cb5553-c1bb-48c8-b439-aebc5202970f',
            ],
            [
                'title' => 'Ueber sclaverei, sclaven-emancipation und die einwanderung "freier neger" nach den colonieen; aufzeichnungen eines weitgereisten.',
                'bibId' => 'f56d3ce3-b31f-4320-8e08-dfc2f9a96c4a',
            ],
            [
                'title' => 'Concerning a full understanding of the southern attitude toward slavery, by John Douglass Van Horne.',
