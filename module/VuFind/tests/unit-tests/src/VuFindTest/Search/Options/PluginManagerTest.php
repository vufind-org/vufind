 ...
 */
namespace VuFindTest\Search\Options;
...
class PluginManagerTest extends \VuFindTest\Unit\TestCase
{
    ...
    {
        $this->setExpectedException(\Zend\ServiceManager\Exception\InvalidServiceException::class, 'Plugin ArrayObject does not belong to VuFind\\Search\\Base\\Options');
