 ...
 */
namespace VuFindTest\Hierarchy\Driver;
...
class PluginManagerTest extends \VuFindTest\Unit\TestCase
{
    ...
    {
        $this->setExpectedException(\Zend\ServiceManager\Exception\InvalidServiceException::class, 'Plugin ArrayObject does not belong to VuFind\\Hierarchy\\Driver\\AbstractBase');
