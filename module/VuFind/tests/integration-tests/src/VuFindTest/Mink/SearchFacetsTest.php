...
class SearchFacetsTest extends \VuFindTest\Integration\MinkTestCase
{
     ...
     * @var string
     */
    protected $facetExpandSelector = '.facet__tree .facet__tree__toggle-expanded .facet__tree__expand';
     ...
     * @var string
     */
    protected $facetExpandedSelector = '.facet__tree button[aria-expanded=true] ~ ul';
     ...
     * @var string
     */
    protected $facetSecondLevelLinkSelector = '.facet__tree button[aria-expanded=true] ~ ul a';
     ...
     * @var string
     */
    protected $facetSecondLevelActiveLinkSelector = '.facet__tree button[aria-expanded=true] ~ ul a.active';
     ...
     * @var string
     */
    protected $facetSecondLevelExcludeLinkSelector = '.facet__tree button[aria-expanded=true] ~ ul a.exclude';
