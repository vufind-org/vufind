<? include('header.php'); ?>
  <div class="row">
    <div class="col-sm-6">
      ...
      <ul>
        <li>Catalog Records
        <li>Digital Library Items
        <li>Institutional Repository
        <li>Institutional Bibliography
        <li>Other Library Collections and Resources
      </ul>
    ...
    <div class="col-sm-6">
      <img src="http://vufind.org/images/magnify.png"/>
      <h2>Praise for VuFind</h2>
      <quote>
        <b>"This completely rules, as you kids say."</b>
        Peter Ivanick, Drexel University
      </quote>
      <quote>
        <b>"I love the 'text this' option in the catalog. It saves paper, I don't have to find the scrap of paper I wrote on, and I don't have to wonder if I transposed the call number. (I just have to have my cell phone with me!) This is a great feature."</b>
